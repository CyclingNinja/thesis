...
\begin{document}
	...
	\maketitle
		\begin{minipage}{0.3\textwidth}
			\begin{flushleft}
				\includegraphics[width=0.8\textwidth]{Images/University_of_Sheffield.eps}
			\end{flushleft}
		\end{minipage}
		\begin{minipage}{0.3\textwidth}
			\begin{center}
				\includegraphics[width=0.5\textwidth]{Images/SP2RC.eps}
			\end{center}
		\end{minipage}
		\begin{minipage}{0.3\textwidth}
			\begin{flushright}
			\includegraphics[width=0.8\textwidth]{Images/SWAT.eps}
			\end{flushright}
		\end{minipage}
	\end{frame}
...
%Background of Macrospicules
	\begin{frame}{Spicules}
		...
		\end{itemize}
		\begin{figure}
			\includegraphics[scale=0.3]{Images/spicules_NASA.jpg}
...
% Motivation for the work
	...
	\begin{figure}
		\begin{center}
			\begin{subfigure}[b]{0.3\textwidth}
				\begin{center}
					\includegraphics[width=\textwidth]{Images/example_ms.png}
				\end{center}
			\end{subfigure}
			\begin{subfigure}[b]{0.495\textwidth}			
				\begin{center}
					\includegraphics[width=\textwidth]{Images/example_evo.png}
				\end{center}
			\end{subfigure}			
		\end{center}
	\end{figure}
	...
	% Basic property histograms
		\begin{figure}
				\includegraphics[scale=0.20]{Images/vel_hist.png}
				\includegraphics[scale=0.20]{Images/len_hist.png}\\
				
				\includegraphics[scale=0.20]{Images/width_hist.png}
				\includegraphics[scale=0.20]{Images/lt_hist.png}
		\end{figure}
	\end{frame}
	...
	% Inclination vs latitude
		...
		\begin{figure}
			\centering
				\includegraphics[scale=0.25]{Images/tilt_vs_lat.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}
		\begin{minipage}{0.49\textwidth}
			\begin{flushleft}
				\includegraphics[width=1\textwidth]{Images/length_max_vs.png}
			\end{flushleft}
		\end{minipage}
		\begin{minipage}{0.49\textwidth}
			\begin{center}
		...
		\begin{minipage}{0.49\textwidth}
			\begin{flushright}
			\includegraphics[width=1\textwidth]{Images/velocity_vs_lt.png}
			\end{flushright}
		\end{minipage}
		\begin{minipage}{0.49\textwidth}
			\begin{itemize}
	...
	\begin{frame}
		\begin{minipage}{0.49\textwidth}
			\begin{flushleft}
				\includegraphics[width=1\textwidth]{Images/length_vs_solarcycle.png}
			\end{flushleft}
		\end{minipage}
		\begin{minipage}{0.49\textwidth}
			\begin{center}
				\includegraphics[width=1\textwidth]{Images/life_vs_solarcycle.png}
			\end{center}
		\end{minipage}\\
		\begin{minipage}{0.49\textwidth}
			\begin{flushright}
			\includegraphics[width=1\textwidth]{Images/velocity_vs_solarcycle.png}
			\end{flushright}
		\end{minipage}
		\begin{minipage}{0.49\textwidth}
			\begin{itemize}
	...
	\begin{frame}{Ballistics and energetics}
		...
		\begin{figure}
			\centering
				\includegraphics[scale = 0.25]{Images/width_percent.png}
				\includegraphics[scale = 0.25]{Images/times_falling.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{Ballistics and energetics}
		...
		\begin{figure}
			\centering	
				\includegraphics[scale = 0.35]{Images/scale_h.png}
		\end{figure}
	\end{frame}
...
%%%%%%%%%%%%%%%%%%%% case study section
	...
	\begin{frame}
		\begin{itemize}
			...
			\end{itemize}
			% need the figure here
			\includegraphics[scale=0.32]{'Figs/'}
		\end{itemize}
	\end{frame}
